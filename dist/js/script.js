...
$.each(data, function(i, item) {
    var cuenta1 = item.cuentas[0].boletas[0][2016];
    var cuenta2 = item.cuentas[0].boletas[0][2017];
...
//array boletas luz
$.each(data, function(i, item) {
    var cuenta1 = item.cuentas[1].boletas[0][2016];
    var cuenta2 = item.cuentas[1].boletas[0][2017];
...
//array boletas gas
$.each(data, function(i, item) {
    var cuenta1 = item.cuentas[2].boletas[0][2016];
    var cuenta2 = item.cuentas[2].boletas[0][2017];
